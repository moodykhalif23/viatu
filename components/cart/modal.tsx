          ...
          >
            <div className="flex flex-row gap-6">
              ...
              <div className="flex flex-col flex-1 gap-2 justify-center 2xl:gap-3">
                <span className="text-lg font-semibold 2xl:text-xl">Your bag is empty</span>
                <p className="text-sm text-muted-foreground hover:underline">Find your perfect pair and add them here</p>
              </div>
            </div>
          </Link>
        </CartContainer>
